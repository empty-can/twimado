...
<br>
	    	<div class="banner">
	    		<img src="<?php echo $user->profile_banner_url;?>" style="width:100%">
	    	</div>
	    	<br>
	    	<div class="icon left">
	    		<img src="<?php echo str_replace('normal.jpg', '200x200.jpg', $user->profile_image_url_https);?>" style="width:100%">
	    	</div>
	    	...
	    	foreach($matomes as $matome) {
	    	    ?>
	    	    ・<a href="//www.suki.pics/matome/timeline.php?matome_id=<?php echo $matome['id'];?>"><?php echo $matome['title'];?></a><br>
	    		<?php
	    	}
	    	?>
	    </div>
